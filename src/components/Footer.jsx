...
const Footer = () => {
	return (
		// Simple branded footer that stays consistent across pages.
		<div className="bg-black">
			<footer className="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4 max-w-7xl mx-auto">
